...
function addPreviewOptions(nodeType) {
    chainCallback(nodeType.prototype, "getExtraMenuOptions", function(_, options) {
        ...
        let optNew = []
        try {
            const previewWidget = this.widgets.find((w) => w.name === "video_preview");
...
function previewVideo(node,file,type){
    ...
    var previewWidget = node.addDOMWidget("video_preview", "preview", element, {
        serialize: false,
        hideOnZoom: false,
        getValue() {
...
app.registerExtension({
	name: "MC:Tools.VideoPreviewer",
	async beforeRegisterNodeDef(nodeType, nodeData, app) {
		if (nodeData?.name == "Tools:PreviewVideo") {
